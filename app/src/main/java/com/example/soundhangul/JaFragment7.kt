...
import kotlinx.android.synthetic.main.fragment_ja_fragment7.*

class JaFragment7 : Fragment() {
    //for tts
    val TAG = "Kakao"
    ...
    override fun onCreateView(
        ...
        var view:View? = inflater.inflate(R.layout.fragment_ja_fragment7, container, false)
