...
import kotlinx.android.synthetic.main.fragment_ja_fragment12.*

class JaFragment12 : Fragment() {

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        var view:View? = inflater.inflate(R.layout.fragment_ja_fragment12, container, false)
