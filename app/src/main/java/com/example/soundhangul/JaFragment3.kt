...
import kotlinx.android.synthetic.main.fragment_ja_fragment3.*

class JaFragment3 : Fragment() {

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        var view:View? = inflater.inflate(R.layout.fragment_ja_fragment3, container, false)
