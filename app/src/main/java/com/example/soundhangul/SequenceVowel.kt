...
import kotlinx.android.synthetic.main.activity_sequence_vowel.*
import java.util.*
...
class SequenceVowel : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        problemParams.topToTop = R.id.sequenceVowel
        problemParams.topMargin = height/10
        problemParams.startToStart = R.id.sequenceVowel
        ...
        answer1Params.startToStart = R.id.sequenceVowel
        answer1Params.marginStart = width/7
        answer1Params.bottomToBottom = R.id.sequenceVowel
        ...
        answer2Params.bottomToBottom = R.id.sequenceVowel
        ...
        answer3Params.bottomToBottom = R.id.sequenceVowel
        ...
        answer4Params.bottomToBottom = R.id.sequenceVowel
        answer4Params.bottomMargin = height/8
        answer4Params.endToEnd = R.id.sequenceVowel
        ...
        answer1Btn.setOnClickListener{
            if(moNum == rnum[0]){
                ...
                answer1Btn.setTextColor(RED)
                tts!!.speak(moStr[rnum[0]], TextToSpeech.QUEUE_FLUSH, null,null)
                Handler().postDelayed({
                    answer1Btn.setTextColor(BLACK)
                }, 200)
            }
        }
        ...
        answer2Btn.setOnClickListener{
            if(moNum == rnum[1]){
                ...
                answer2Btn.setTextColor(RED)
                tts!!.speak(moStr[rnum[1]], TextToSpeech.QUEUE_FLUSH, null,null)
                Handler().postDelayed({
                    answer2Btn.setTextColor(BLACK)
                }, 200)
            }
        }
        answer3Btn.setOnClickListener{
            if(moNum == rnum[2]){
                ...
                answer3Btn.setTextColor(RED)
                tts!!.speak(moStr[rnum[2]], TextToSpeech.QUEUE_FLUSH, null,null)
                Handler().postDelayed({
                    answer3Btn.setTextColor(BLACK)
                }, 200)
            }
        }
        answer4Btn.setOnClickListener{
            if(moNum == rnum[3]){
                ...
                answer4Btn.setTextColor(RED)
                tts!!.speak(moStr[rnum[3]], TextToSpeech.QUEUE_FLUSH, null,null)
                Handler().postDelayed({
                    answer4Btn.setTextColor(BLACK)
                }, 200)
            }
        }
