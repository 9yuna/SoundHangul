...
import kotlinx.android.synthetic.main.fragment_ja_fragment9.*

class JaFragment9 : Fragment() {

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        var view:View? = inflater.inflate(R.layout.fragment_ja_fragment9, container, false)
