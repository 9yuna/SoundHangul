...
import kotlinx.android.synthetic.main.fragment_ja_fragment8.*

class JaFragment8 : Fragment() {
    //for tts
    val TAG = "Kakao"
    ...
    override fun onCreateView(
        ...
        var view:View? = inflater.inflate(R.layout.fragment_ja_fragment8, container, false)
