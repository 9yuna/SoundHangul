...
import kotlinx.android.synthetic.main.fragment_ja_fragment5.*

class JaFragment5 : Fragment() {
    //for tts
    val TAG = "Kakao"
    ...
    override fun onCreateView(
        ...
        var view:View? = inflater.inflate(R.layout.fragment_ja_fragment5, container, false)
