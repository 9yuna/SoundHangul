...
import kotlinx.android.synthetic.main.fragment_ja_fragment2.*

class JaFragment2 : Fragment() {
    ...
    override fun onCreateView(
        ...
        var view:View? = inflater.inflate(R.layout.fragment_ja_fragment2, container, false)
